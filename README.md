...
```
cd existing_repo
git remote add origin https://gitlab.com/radulucavictor/Akkodis.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/radulucavictor/Akkodis/-/settings/integrations)
